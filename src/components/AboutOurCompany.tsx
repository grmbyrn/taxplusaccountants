  ...
  <div>
    <div className="flex flex-col md:flex-row md:items-center mb-12">
      ...
      <p className="text-lg text-muted-foreground mt-4 md:mt-0">
        Our commitment to excellence, integrity, and client satisfaction has
        made us the go-to accounting firm for businesses who value precision,
        reliability, and strategic financial insight.
      </p>
    </div>
    {/* Accountant image */}
    <Image
    ...
    <div className="mt-8">
      ...
      <p className="text-lg text-muted-foreground">
        Founded in 2009, TaxPlus Accountants has been the trusted financial
        partner for hundreds of businesses across the region. Our team of
        certified public accountants and financial experts brings decades of
        combined experience to help you navigate complex financial challenges.
      </p>
    </div>
    {/* Stats */}
