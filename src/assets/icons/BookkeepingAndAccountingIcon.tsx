const BookkeepingAndAccountingIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  {...props}
                  ...
                  fill="currentColor"
                  viewBox="0 0 256 256"
                  className="w-6 h-6 text-amber-500 group-hover:text-navy transition-colors"
                >
                  <path d="M224,56V208l-32-16-32,16-32-16L96,208,64,192,32,208V56a8,8,0,0,1,8-8H216A8,8,0,0,1,224,56Z" opacity="0.2"></path>
...
export default BookkeepingAndAccountingIcon;